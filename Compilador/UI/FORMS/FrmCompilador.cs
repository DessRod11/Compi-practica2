    ...
    public partial class FrmCompilador : Form
    {
        ...
        private void btnCompilar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Validar que haya texto en txtEditor
                if (string.IsNullOrWhiteSpace(txtEditor.Text))
                {
                    MessageBox.Show("El campo fuente está vacío. Por favor, ingrese o abra un archivo para compilar.",
                                    "Advertencia",
            ...
            {
                MessageBox.Show("Error al compilar: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
